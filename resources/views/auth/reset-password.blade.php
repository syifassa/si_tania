    ...
    <div class="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-green-100
        ...
        <div class="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl w-full max-w-md p-8 relative border border-white/50">
            ...
            <div class="text-center mb-7 mt-2">
                ...
                <h1 class="text-2xl font-bold text-green-700">Buat Password Baru</h1>
                <p class="text-gray-400 text-sm mt-0.5">Masukkan email dan password baru Anda</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" placeholder="email@contoh.com" class="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-sm bg-gray-50 focus:bg-white focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition @error('email') border-red-300 bg-red-50 @enderror" required autofocus>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" placeholder="Minimal 8 karakter" class="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-sm bg-gray-50 focus:bg-white focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition @error('password') border-red-300 bg-red-50 @enderror" required>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 text-sm"><i class="fas fa-check-circle"></i></span>
                        <input type="password" name="password_confirmation" placeholder="Ulangi password baru" class="w-full border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-sm bg-gray-50 focus:bg-white focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition" required>
                    </div>
                </div>
